...
$label['check_sel_notavailable']='This space is not available! Please try to place your pixels in a different area.';
$label['ads_list_days_ago']='Days ago';
$label['ads_list_day_ago']='Day ago';
$label['ads_list_today']='Today!';
$label['ads_list_no_image']='No Image.';
...
$label['navigation_page']='Page %CUR_PAGE% of %PAGES% - ';
...
$label['advertiser_signup_heading2']='Sign up for an account';
$label['advertiser_signup_first_name']='First Name';
$label['advertiser_signup_last_name']='Last Name';
...
$label['advertiser_signup_your_email']='Email';
$label['advertiser_signup_your_email2']='Can be your Drupal.org email, but does not have to be.';
...
$label['advertiser_signup_reset']='Reset';
$label['advertiser_signup_error']='Cannot continue due to the following errors:<p>';
$label['advertiser_signup_error_name']='* Please fill in your first name<br/>';
$label['advertiser_signup_error_ln']='* Please fill in your last name<br/>';
$label['advertiser_signup_error_user']='* Please fill in your username.<br/>';
$label['advertiser_signup_error_inuse']='* The username \'%username%\' is in use. Please choose a different Member I.D. <br/>';
$label['advertiser_signup_error_p']='* Please fill in your password <br/>';
...
$label['advertiser_login_error']='Error: username/password combination is incorrect. <a href="index.php">Try again.</a></div><div class="alert alert-secondary text-center" role="alert">If you have forgotten your password, please <a href=\'forgot.php\'>reset it</a>.<br>Please <a href=\'signup.php\'>sign up</a> if you are a new user.';
$label['advertiser_login_disabled']='Note: this account is not validated. Please check your email for the validation message';
$label['advertiser_login_success']='Welcome back %firstname% %lastname%. You have successfully signed in as \'%username%\' <br/>Processing Login... If this page appears for more than 5 seconds <a href=\'index.php\'>click here to reload.</a><p>';
...
$label['advertiser_could_not_signup']='Could not sign up, try using another username or contact support by clicking here';
$label['advertiser_signup_goback']='<a href=\'index.php\'>Continue</a>';
$label['yes_option']='Yes';
$label['no_option']='No';
$label['advertiser_signup_language']='Select your preferred language:';
$label['advertiser_pass_forgotten']='Forgotten your Password';
$label['advertiser_forgot_title']='Forgot my password';
$label['advertiser_forgot_enter_email']='Enter your Email address';
...
$label['advertiser_forgot_success1']='A new password was sent to your email address. Please allow some time for your new password to arrive. You will be able to <a href="%BASE_HTTP_PATH%users/">log in with the new password here</a>.';
...
$label['advertiser_join_now']='Create a new account';
$label['advertiser_signup_continue']='Click Here to Continue';
$label['advertiser_logout_ok']='You have logged out.';
$label['advertiser_logout_home']='%SITE_NAME% Home';
...
$label['adv_pub_editad_head']='Edit your pixels';
$label['adv_pub_editad_desc']='Here you can edit your pixels.';
...
$label['adv_pub_edityourad']='Edit your pixels:';
$label['adv_pub_adsaved']='Pixels saved';
$label['adv_pub_yourads']='My Pixels';
$label['advertiser_pay_navmap']='1. Select Your pixels -> 2. Confirm Order -> 3. <b>Payment</b> -> 4. Image Upload & Publish your pixels';
$label['advertiser_pay_sel_method']='Enter your voucher code:';
...
$label['advertiser_ord_price']='Amount redeemed';
...
$label['advertiser_home_blkyouown']='You own %PIXEL_COUNT% pixels. <a href=\'publish.php\'>Manage my pixels</a>';
$label['advertiser_home_blkonorder']='You have %PIXEL_ORD_COUNT% pixels on order. <a href=\'select.php\'>Upload Pixels</a> / <a href=\'orders.php\'>View Order History</a>';
...
$label['advertiser_header_nav2']='Upload Pixels';
