...
define( 'BASE_HTTP_PATH', 'http://nginx-drupalcareshomepage.docker.amazee.io/' );
define( 'BASE_PATH', __DIR__ );
define( 'SERVER_PATH_TO_ADMIN', __DIR__ . '/admin/' );
define( 'UPLOAD_PATH', __DIR__ . '/upload_files/' );
define( 'UPLOAD_HTTP_PATH', 'http://nginx-drupalcareshomepage.docker.amazee.io/upload_files/' );
...
define( 'MYSQL_SOCKET', '' );
define( 'ADMIN_PASSWORD', 'serupas8f23or70abf98asfv979hr87jasf' );
...
define( 'VOUCHER_IMPORT_HASH_SALT', 'or((|*D)9qa-weSwEP)>s"l-%5.^;{l');
