(function () {
    // Variables
    var Photo, addListeners, canvas, container, createGrid, ctx, gridItem, grids, height, img, imgInfo, imgSrc, imgs, init, magnet, mouse, populateCanvas, render, resizeCanvas, rotateAndPaintImage, updateMouse, useGrid, width;

    container = document.getElementById('main-top-header');
    ...
    resizeCanvas = function () {
        width = canvas.width = window.innerWidth;
        return height = canvas.height = container.offsetHeight;
    };
