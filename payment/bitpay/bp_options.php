...
$bpOptions['apiKey'] = BITPAY_APIKEY;
...
$bpOptions['notificationEmail'] = (BITPAY_NOTIFICATIONEMAIL == "http") ? SITE_CONTACT_EMAIL : "";
...
$bpOptions['notificationURL'] = BASE_HTTP_PATH;
